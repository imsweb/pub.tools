...
from pub.tools import formatting
from pub.tools.config import NO_VALUE
...
class TestFormatting:
    ...
    def test_datetime1(self):
        ...
        d = formatting.format_date(None, None, None, pre)
        assert d.year == expected.year
        assert d.month == expected.month
        assert d.day == expected.day
    ...
    def test_date_months(self):
        ...
        d = formatting.format_date_months(
            start=formatting.format_date(None, None, None, pre),
