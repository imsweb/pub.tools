...
rmap={'winter':'Winter','spring':'Spring','summer':'Summer','fall':'Fall','autumn':'Autumn','win':'Win','spr':'Spr','sum':'Sum','fal':'Fal','aut':'Aut',
      'jan':'Jan','january':'Jan','feb':'Feb','february':'Feb','mar':'Mar','march':'Mar','apr':'Apr','april':'Apr','may':'May','jun':'Jun','june':'Jun',
      'jul':'Jul','july':'Jul','aug':'Aug','august':'Aug','sep':'Sep','september':'Sep','oct':'Oct','october':'Oct','nov':'Nov','november':'Nov',
...
def cookDateStr(value):
  ...
  try:
    ...
    year=month=day=''
    # 2006 Dec-2007 Jan
    len(vals)==3 and len(vals[1].split('-'))>1 and ord(vals[1].split('-')[1][0]) in range(48,58)
