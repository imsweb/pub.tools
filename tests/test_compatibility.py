...
class TestCitationsBackwardsCompatibility:
    ...
    def test_journal_citation(self):
        ...
        assert citation == journal_citation(html=True, **record)
    ...
    def test_journal_abstract_citation(self):
        ...
        citation = (
            '<span class="citation">Wohnlich E, Carter G. My title. '
    ...
    def test_book_citation(self):
        record = {
            "title": "My title",
            "authors": (
                {"lname": "Wohnlich", "iname": "E"},
                {"lname": "Carter", "iname": "G"},
            ),
        ...
        assert citation == book_citation(html=True, **record)
    ...
    def test_chapter_citation(self):
        ...
        citation = (
            '<span class="citation">Wohnlich E, Carter G. My title. In: '
            "Van Halen E, editor. My Book. First Edition. "
            "New York: Doubleday; 2007 Dec. p. 243. (My series)</span>"
        )
        assert citation == chapter_citation(html=True, **record)
        ...
        record["authors"] = []
        citation = (
            '<span class="citation">Van Halen E, editor. My title. '
    ...
    def test_conference_citation(self):
        ...
        citation = (
            '<span class="citation">Wohnlich E, Battle J. My title. Sagan C, '
            "Thorne K, editors. <i>Proceedings of Conference "
            "name</i>; 2007 Dec; New York. Boston: Doubleday; 2008 Jan. p. 345.</span>"
        )
        assert citation == conference_citation(html=True, **record)

        record["authors"] = []
        citation = (
            '<span class="citation">Sagan C, Thorne K, editors. My title. '
    ...
    def test_monograph_citation(self):
        ...
        assert citation == monograph_citation(html=True, **record)
        ...
        record["pubplace"] = ""
        citation = (
            '<span class="citation">Wohnlich E, Battle J; Series name. Hawking S, '
    ...
    def test_report_citation(self):
        record = {
            ...
            "editors": (
                {"lname": "Hawking", "iname": "S"},
                {"lname": "Wheeler", "iname": "J"},
            ),
            "series": "Series name",
            "reportnum": "5",
            "weburl": "http://plone.org",
        ...
        assert citation == report_citation(html=True, **record)
